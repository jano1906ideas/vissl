...
class vit_models(nn.Module):
    ...
    def __init__(self, img_size=224,  patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
        ...
        self.division_masks = DIVISION_MASKS[14]
        ...
        #self.subpatch_embed = Patch_layer(
        #        img_size=img_size//4, patch_size=patch_size, in_chans=in_chans, embed_dim=embed_dim)
        ...
        self.cache_cls = torch.zeros_like(self.cls_token)
        self.cache_feats = []
